		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Reservation",
									"targetURL": "#zppreservation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zppreservation-display": {
								"semanticObject": "zppreservation",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zppreservation",
									"url": sap.ui.require.toUrl("zppreservation")
								}
							}
						}
					}
